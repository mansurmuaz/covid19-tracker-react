...
const worldChart = (props) => {
    ...
    return (
        <ComposedChart width={730} height={300} data={data}
            ...
            <Area yAxisId="left" type="monotone" name="Total Cases" dataKey="totalCases" stroke="#8884d8"
                  fillOpacity={1} fill="url(#colorUv)"/>
            <Area yAxisId="left" type="monotone" name="Total Deaths" dataKey="totalDeaths" stroke="#ff0000"
